...
public class Context
{
    ...
    public static void addContextListener(ContextListener listener)
    {
        ...
        String DBG = "jp.sf.amateras.jseditor.rhino.javascript.tools.debugger.Main";
        if (DBG.equals(listener.getClass().getName())) {
            Class<?> cl = listener.getClass();
            Class<?> factoryClass = Kit.classOrNull(
                "jp.sf.amateras.jseditor.rhino.javascript.ContextFactory");
     ...
     *
     * @see jp.sf.amateras.jseditor.rhino.javascript.ErrorReporter
     */
     ...
     * @see jp.sf.amateras.jseditor.rhino.javascript.SecurityController
     */
     ...
     * @exception IOException if an IOException was generated by the Reader
     * @see jp.sf.amateras.jseditor.rhino.javascript.Script
     */
    ...
    private static Class<?> codegenClass = Kit.classOrNull(
                             "jp.sf.amateras.jseditor.rhino.javascript.optimizer.Codegen");
    private static Class<?> interpreterClass = Kit.classOrNull(
                             "jp.sf.amateras.jseditor.rhino.javascript.Interpreter");
    ...
    RegExpProxy getRegExpProxy()
    {
        if (regExpProxy == null) {
            Class<?> cl = Kit.classOrNull(
                          "jp.sf.amateras.jseditor.rhino.javascript.regexp.RegExpImpl");
            if (cl != null) {
