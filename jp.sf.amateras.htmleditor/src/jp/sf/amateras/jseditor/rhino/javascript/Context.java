...
package jp.sf.amateras.jseditor.rhino.javascript;
...
import jp.sf.amateras.jseditor.rhino.javascript.debug.DebuggableScript;
import jp.sf.amateras.jseditor.rhino.javascript.debug.Debugger;
import jp.sf.amateras.jseditor.rhino.javascript.xml.XMLLib;
...
public class Context
{
    ...
    public static void addContextListener(ContextListener listener)
    {
        ...
        String DBG = "tk.eclipse.plugin.jseditor.rhino.javascript.tools.debugger.Main";
        if (DBG.equals(listener.getClass().getName())) {
            Class<?> cl = listener.getClass();
            Class<?> factoryClass = Kit.classOrNull(
                "tk.eclipse.plugin.jseditor.rhino.javascript.ContextFactory");
     ...
     *
     * @see tk.eclipse.plugin.jseditor.rhino.javascript.ErrorReporter
     */
     ...
     * @see tk.eclipse.plugin.jseditor.rhino.javascript.SecurityController
     */
            ...
            throws ContinuationPending
    {
        ...
        return Interpreter.restartContinuation(
                (jp.sf.amateras.jseditor.rhino.javascript.NativeContinuation) continuation,
                this, scope, args);
    }
     ...
     * @exception IOException if an IOException was generated by the Reader
     * @see tk.eclipse.plugin.jseditor.rhino.javascript.Script
     */
    ...
    private static Class<?> codegenClass = Kit.classOrNull(
                             "tk.eclipse.plugin.jseditor.rhino.javascript.optimizer.Codegen");
    private static Class<?> interpreterClass = Kit.classOrNull(
                             "tk.eclipse.plugin.jseditor.rhino.javascript.Interpreter");
    ...
    RegExpProxy getRegExpProxy()
    {
        if (regExpProxy == null) {
            Class<?> cl = Kit.classOrNull(
                          "tk.eclipse.plugin.jseditor.rhino.javascript.regexp.RegExpImpl");
            if (cl != null) {
